                            ...
                            <div class="col-lg-8 col-md-8">
                                ...
                                <form method="post">
                                    ...
                                    <div class="mt-10">
                                        ...
                                        <input type="text" name="user-first-name" id="user-firs-name"
                                    ...
                                    <div class="mt-10">
                                        ...
                                        <input type="text" name="user-phone" id="user-phone" placeholder="380959956781"
                                               ...
                                               onblur="this.placeholder = '380959956781'"
                                    ...
                                    <div class="input-group-icon mt-10">
                                        ...
                                        <input type="text" name="user-status" id="user-role" disabled
                                               value="${user.role}"
                                               pattern="^(\p{L}+[\s]*)+$"
                                               onfocus="this.placeholder = ''"
                                    ...
                                    <div class="input-group-icon mt-10">
                                        <div class="form-select" id="default-select">
                                            ...
                                            <input type="text" name="user-status" id="user-status" disabled
                                                   value="${user.status}"
                                                   pattern="^(\p{L}+[\s]*)+$"
                                                   onfocus="this.placeholder = ''"
                                                   onblur="this.placeholder = 'About yourself'"
