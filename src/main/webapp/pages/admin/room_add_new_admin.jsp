...
<fmt:message key="room.add.admin" bundle="${localeBundle}" var="pageLoginTitle" scope="page"/>
                    ...
                    <div class="section-top-border">
                        <div class="row">
                            <div class="col-lg-8 col-md-8">
                                <h3 class="mb-30">
                                    <fmt:message key="room.new" bundle="${localeBundle}"/>
                                ...
                                <form method="post">
                                    ...
                                    <div class="mt-10">
                                        ...
                                        <input type="number" name="room-adult-capacity" id="room-adult-capacity"
                                               placeholder="Adult Capacity"
                                               pattern="^([0-9]+)$"
                                               onfocus="this.placeholder = ''"
                                               onblur="this.placeholder = 'Adult Capacity'"
                                               onchange="this.setCustomValidity(this.validity.patternMismatch ? 'Must be digit' : '');"
                                               class="single-input"
                                               required>
                                    </div>
                                    ...
                                    <div class="mt-10">
                                        ...
                                        <input type="number" name="room-children-capacity" id="room-children-capacity"
                                               placeholder="Children Capacity"
                                               pattern="^([0-9]+)$"
                                               onfocus="this.placeholder = ''"
                                               onblur="this.placeholder = 'Children Capacity'"
                                               onchange="this.setCustomValidity(this.validity.patternMismatch ? 'Must be digit' : '');"
                                               class="single-input"
                                               required>
                                    </div>
                                    ...
                                    <div class="mt-10">
                                        ...
                                        <input type="number" min="0.00" step="0.01" name="room-price" id="room-price" placeholder="10.29"
                                               pattern="^([0-9]{1,}\.?[0-9]{2})$"
                                               onfocus="this.placeholder = ''" onblur="this.placeholder = '10.29'"
                                    ...
                                    <button class="btn btn-lg btn-primary btn-block" type="submit"
                                            formaction="room-add-new-admin.command">
                                        <fmt:message key="create" bundle="${localeBundle}"/>
                                    </button>
                                    <button class="btn btn-lg btn-primary btn-block" type="submit"
